...
public interface CommunityMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-27T16:19:13.6742337+08:00", comments="Source Table: community.community")
    BasicColumn[] selectList = BasicColumn.columnList(id, title, description, createTime, deleteTime);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-27T16:19:13.6627738+08:00", comments="Source Table: community.community")
    ...
    int insertMultiple(MultiRowInsertStatementProvider<Community> multipleInsertStatement);
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-27T16:19:13.6727019+08:00", comments="Source Table: community.community")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2021-12-27T16:19:13.6742337+08:00", comments="Source Table: community.community")
    default int insertMultiple(Collection<Community> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, community, c ->
            c.map(id).toProperty("id")
            .map(title).toProperty("title")
            .map(description).toProperty("description")
            .map(createTime).toProperty("createTime")
